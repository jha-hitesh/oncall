CELERY_TASK_ROUTES = {
    ...
    "apps.google.tasks.check_google_calendar_connection_for_organization": {"queue": "critical"},
    "apps.google.tasks.check_google_calendar_connections_for_all_organizations": {"queue": "critical"},
