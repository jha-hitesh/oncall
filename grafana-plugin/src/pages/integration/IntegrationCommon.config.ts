...
export const IntegrationTemplateOptions = {
  ...
  SlackCreateCustomChannel: new KeyValuePair('slack_create_custom_channel_template', 'Create Custom Channel'),
  SlackChannelPayload: new KeyValuePair('slack_channel_payload_template', 'Channel Payload'),
  GoogleCalendarTitle: new KeyValuePair('google_calendar_title_template', 'Title'),
  GoogleCalendarDescription: new KeyValuePair('google_calendar_description_template', 'Description'),
